import { BuildIdeaContentBlockType } from "@/components/sections/buildIdea"
import {
  FileText,
  AudioLines,
  HeartPulse,
...
export const BuildIdeaContentData: {
  Assistants: BuildIdeaContentBlockType[]
  ...
  Assistants: [
    ...
    },
    {
      ...
      description: "Integrate voice assistant technology for operational efficiency.",
    ...
    },
    {
      ...
      description: "Improve patient experience and operational efficiency in healthcare.",
      demoURL: "https://www.stack-ai.com/solutions/use-cases/healthcare-assistant",
    },
  ],
  Chatbots: [
    {
    ...
    },
    {
      ...
      description: "Simplify the onboarding process with an interactive chatbot.",
      demoURL: "https://www.stack-ai.com/solutions/chatbots",
    },
  ],
  Automations: [
    ...
    },
    {
      ...
      description: "Effortlessly create engaging weekly newsletters with AI assistance.",
      demoURL: "https://www.stack-ai.com/solutions/workflow-automation",
    },
  ],
}