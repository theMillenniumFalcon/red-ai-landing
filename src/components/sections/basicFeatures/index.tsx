...
const BasicFeatureList: FeatureContentProps[] = [
  {
    ...
    description: "Build AI applications with a drag and drop interface. No coding required.Deploy your applications using Customizable UIs or ready to use API endpoints.",
  },
  {
    icon: "prebuilt",
    title: "Pre-built Use Cases",
    description: "Leverage an extensive library of Templates inspired by real use cases. Get immediate results and customize to your needs.",
  },
  {
    icon: "security",
  ...
  },
  {
    ...
    description: "Deploy AI applications with the help of MIT engineers and PhDs with over 10 years of experience in the field.",
  },
]

export const BasicFeatureSection = () => {
  return (
